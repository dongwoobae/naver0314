...
<body>
	<table class="table table-bordered" style="width: 500px;">
		...
		<tr>
			<td rowspan="5"><img src="../image/${dto.photo}" width="200"
				id="photo"></td>
		</tr>
		<tr>
			<th>핸드폰 번호</th>
		...
		<tr>
			...
			<td colspan="3" align="center">
				<button type="button" class="btn btn-primary"
					onclick="location.href='./updateform?myid=${dto.myid}'">수정</button>
	...
	<form action="../comment/insert" method="post">
		<table style="width: 500px;">
			...
			<tr>
				...
				<input type="text" name="myid" hidden="hidden" value="${dto.myid}">
				</td>
