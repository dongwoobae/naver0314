...
public class MemberDao {
	...
	public MemberDto getOneMember(String myid) {
		return session.selectOne(namespace+"getOneMember", myid);
	}
	...
	public boolean equalPassCheck(Map<String, Object> map) {
		int n=session.selectOne(namespace+"equalPassCheck", map);
		return n==1?true:false;//count 반환이 1이면 비번이 맞은 거고 0이면 틀린거니까
	}
}
